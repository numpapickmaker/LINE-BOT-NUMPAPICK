...
function Edit() {
          ...
          var b = document.getElementById("Lastname").innerHTML;
            ...
            document.getElementById("Firstname").innerHTML='<input id="Firstnamefld"  name="Firstname" type="text" value="'+a+'"'+' />';
...
<table class="w3-table w3-striped Taviraj" id="customers" align="center">
   <tr>
          ...
          <td >div class="form-group <?php echo (!empty($firstname_err)) ? 'has-error' : ''; ?>"><label id="Firstname"><?php echo $Firstname;?></label><span class="help-block"><?php echo $firstname_err; ?></span>
    </div></td>
          </tr>
