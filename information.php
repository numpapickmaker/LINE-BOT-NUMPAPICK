...
if( $_GET["name"]|| $_GET["age"]|| $_GET["sex"]|| $_GET["heigth"]|| $_GET["weigth"]|| $_GET["disease"]|| $_GET["address"]|| $_GET["Phone"]){
  ...
  $host        = "host=ec2-54-83-48-188.compute-1.amazonaws.com";
     ...
     $sql ="UPDATE Device_information set name='"._$GET["name"]."' , age='"._$GET["age"]."' ,sex='"._$GET["sex"]."', heigth='"._$GET["heigth"]."',weigth='"._$GET["weigth"]."', disease='"._$GET["disease"]."' ,address='"._$GET["address"]."'WHERE Device_id='".$_GET["device_id"]."';";
    $ret = pg_query($db, $sql) ;
      if(!$ret) {
