...
function Edit() {
          ...
          var b = document.getElementById("birthday").innerHTML;
            ...
            document.getElementById("Password").innerHTML=''+pw+'<form action="https://numpapick.herokuapp.com/password_manage.php" method="get">  <input type="hidden" name="username" class = "Taviraj" value="<?php echo $_GET["username"];?>" > <button  value="<?php echo $_GET["view"];?>"name="view">change password</button></form> ';
